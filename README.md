...
| --- | --- |
| [Windows desktop: GUI and TUI](https://github.com/FahrenheitResearch/arwen/releases/download/v2.7.3/ArWen-Desktop-1.0.3-Windows-x64.zip) | x86-64 Windows; compatible NVIDIA GPU and driver; internet for first setup |
| [Linux desktop: GUI and TUI](https://github.com/FahrenheitResearch/arwen/releases/download/v2.7.3/ArWen-Desktop-1.0.3-Linux-x64-pip.tar.gz) | x86-64 Linux, glibc 2.39 or newer, such as Ubuntu 24.04; Python 3.11 or newer; X11 or Wayland with working OpenGL |
| [Integration kit](https://github.com/FahrenheitResearch/arwen/releases/download/v2.7.3/ArWen-2.7.3-Integration-Kit.zip) | Developer guide, CLI/plan examples, catalogs, and client design notes |
...
separate download above. Check [release notes and checksums](https://github.com/FahrenheitResearch/arwen/releases/tag/v2.7.3)
...
[ArWen hardware guidance](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/docs/public/HARDWARE.md).
...
`gpuwm[render]==2.7.3` without a GPU extra. It cannot execute local forecasts.
...
[CLI manual](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/docs/public/CLI-USER-MANUAL.md)
and [TUI manual](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/docs/public/TUI-USER-MANUAL.md)
for the complete workflows.

## Integrate ArWen into another application

The [integration guide](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/docs/integration-kit/integration-guide.md)
and [downloadable kit](https://github.com/FahrenheitResearch/arwen/releases/download/v2.7.3/ArWen-2.7.3-Integration-Kit.zip)
...
[verification record](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/docs/public/VERIFICATION.md),
[physics documentation](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/docs/public/PHYSICS.md),
and [2.7 changes](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/CHANGELOG.md).
...
or private keys. See
[reporting a problem](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/docs/public/REPORTING-A-PROBLEM.md).
...
The engine is licensed under the [Apache License 2.0](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/LICENSE).
...
their respective terms; see [NOTICE](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/NOTICE)
and [scientific provenance](https://github.com/FahrenheitResearch/arwen/blob/v2.7.3/PROVENANCE.md).
