...
# The CPU-only coupling declarations run on every platform in their own
# module; importing this shared selector set does not open a device.
from test_rrtmgp_coupling import _RTE_RRTMGP_COUPLED_MP_PHYSICS
