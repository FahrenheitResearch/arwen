...
/// the cdylib is built from crates and vendored dependencies across it.
...
fn head_of_clean_checkout() -> Option<String> {
    ...
    // writer's default feature is dependency-free, so the workspace root
    // pathspec covers everything that can enter this cdylib.
