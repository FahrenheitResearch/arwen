...
- Initialization clamps the correct geopotential quantity when extending source levels below terrain. The affected case's potential-temperature error falls from about 3.56 K to 0.00053 K against the independent WRF initialization reference; the unchanged control retains identical data. This measures initialization agreement, not forecast skill.
